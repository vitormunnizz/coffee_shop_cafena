...
```bash
# Clone o repositório
git clone https://github.com/seu-usuario/coffee_shop_cafena-main.git

# Acesse o diretório
cd coffee_shop_cafena-main
...
* Efeitos de rolagem e animações suaves
...
* Criar página de produtos dinâmica com JavaScript
